...
class PastProjects extends React.Component {
    ...
    tagLink() {
        for (var j = 0; this.props.images.length; j++) {
            if (this.props.images[j] != null) {
            ...
            <React.Fragment>
                <div id="Projects">
                    <div className="all-projects">
                        <Card.Body className="Title-projects">{t("Projects")}</Card.Body>
    ...
    images: [
        {
            ...
            thumbnailHeight: 174,
            tags: [{
                value: <Link  href="#Description1"
                    to="Description1"
                    activeClass="active"
                    spy={true}
                    smooth={true}
                    offset={-50}
                    duration={500}>testing</Link>, title: "Testing" }, { value: "Flora", title: "Flora" }],
        ...
        },
        {
            ...
            thumbnailHeight: 212,
            tags: [{
               value: < Link  href = "#Description2"
                    to = "Description2"
                    activeClass = "active"
                    spy = { true}
                    smooth = { true}
                    offset = {- 50}
                    duration = { 500} > testing2</ Link>, title: "Testing2"
...
export default (withTranslation()(PastProjects));